...
function diana_scripts() {
	...
	if(is_page('academic-programs')){
		...
		wp_enqueue_script( 'programs', get_template_directory_uri() . '/js/programs.js', array(),  '20250731', true );
	}
	...
	wp_enqueue_script( 'diana-script', get_template_directory_uri() . '/js/script.min.js', array(), '20250512', true );
