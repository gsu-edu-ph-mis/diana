				...
				<div class="college mb-5 pb-5">
					<div class="row mb-5 align-items-end">
						...
						<div class="col-md-6 official">
							...
							<h4 class="h4">Chairperson, Commission on Higher Education</h4>
							<h4 class="h5">Chairperson, GSU Board of Regents</h4>
						</div>
						<div class="col-md-6 official">
							<div class="official-photo mb-3">
							...
							<h4 class="h5">Vice Chairperson, GSU Board of Regents</h4>
						</div>
					</div>
					<div class="row mb-5">
						<div class="col-md-6 official ">
							<div class="official-photo-2 mb-3">
								<img src="<?= get_stylesheet_directory_uri(); ?>/images/officials/allan.cayetano.jpg" width="250" height="250" alt="Profile Photo">
							</div>
							<h3 class="h3">Hon. Allan Peter Cayetano</h3>
							<h4 class="h4">Chairperson, Senate Committee on Higher, Technical, and Vocational Education</h4>
						...
						<div class="col-md-6 official ">
							...
							<h4 class="h4">Chairperson, House of Representatives Committee on Higher and Technical Education</h4>
							<h4 class="h5">Member</h4>
					...
					<div class="row mb-5">
						...
						<div class="col-md-4 official ">
							...
							<h4 class="h4">President, Federated Faculty Association, Inc.</h4>
							<h4 class="h5">Member</h4>
						</div>
						<div class="col-md-4 official ">
							<div class="official-photo-2 mb-3">
								<img src="<?= get_stylesheet_directory_uri(); ?>/images/officials/vevelyn.velez.jpg" width="250" height="250" alt="Profile Photo">
							</div>
							<h3 class="h3">Hon. Vevelyn H. Velez</h3>
