					...
					<div id="ceit" class="college-programs">
						...
						<div class="programs">
							<div>
								...
								<p class="mb-0">Major in: Automotive Technology, Electrical Technology, Electronics Technology, Mechanical Technology</p>
							</div>
							<div>
