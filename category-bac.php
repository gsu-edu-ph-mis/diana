		...
		<main id="main" class="row pt-5 pb-5  text-left" role="main">
			<div class="order-2 col-md-9">
				<?php if ( have_posts() ) : 
					...
					$posts_per_page  = $wp_query->query_vars['posts_per_page'] > -1 ? $wp_query->query_vars['posts_per_page'] : 0;
					?>
					<h2 class="h2 mb-5">There are <?= $wp_query->found_posts; ?> postings found</h2>
					<div class="table-responsive mb-5">
						<table class="table table-striped">
							...
							<tr>
								...
								<td><?php the_title(); ?></td>
								<td><a class="btn" href="<?php echo get_permalink( $post->ID); ?>">
				...
				<?php else : ?>
					<h2 class="h2 mb-5">No postings found</h2>
				<?php endif; ?>
			</div>
