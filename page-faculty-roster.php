			...
			<div class="col-md-8 order-2">
				...
				<div class="college mb-5 pb-5">
					...
					<div class="row mb-5">
						<div class="col-md-4 official">
							...
							<h4 class="h4">Research Coordinator</h4>
						...
						<div class="col-md-4 official">
							...
							<h4 class="h4">Student Affairs and Services Coordinator / Extension Coordinator</h4>
						</div>
					</div>
				</div>
				<div class="college mb-5 pb-5">
					...
					<!-- <h2 id="cbm" class="h2 mb-5 text-center">Program Heads</h2> -->
					<div class="row mb-5">
						<div class="col-md-4 official">
						...
						<div class="col-md-4 official">
							...
							<h3 class="h3">Instr. Lea P. Ymalay</h3>
						...
						<div class="col-md-4 official">
							...
							<h3 class="h3">Instr. Jed Sorolla</h3>
				...
				<div class="college mb-5 pb-5">
					...
					<div class="row mb-5">
						...
						<div class="col-md-4 official">
							...
							<h4 class="h4">Program Head, BS Real Estate Management</h4>
						</div>
						<div class="col-md-4 official">
							<div class="official-photo-2 mb-3">
					...
					<div class="row mb-5">
						...
						<div class="col-md-4 official  mb-4">
							...
							<h3 class="h3">Instr. Shiela Mae V. Artajo-Diaz</h3>
						</div>
						<div class="col-md-4 official  mb-4">
							<div class="official-photo-3 mb-3">
						...
						<div class="col-md-4 official  mb-4">
							...
							<h3 class="h3">Instr. Ronald  Gentapanan</h3>
						</div>
						<div class="col-md-4 official  mb-4">
							<div class="official-photo-3 mb-3">
				...
				<div class="college mb-5 pb-5">
					...
					<div class="row mb-5">
						...
						<div class="col-md-4 official">
							<div class="official-photo mb-3">
								<img src="<?= get_stylesheet_directory_uri(); ?>/images/officials/jufel.fernandez.jpg" alt="Jufel Fernandez">
							</div>
					...
					<div class="row mb-5">
						...
						<div class="col-md-4 official">
							...
							<h3 class="h3">Instr. Shiela Mae S. Paltiquera</h3>
						</div>
					</div>
				</div>
				<div class="college mb-5 pb-5">
					...
					<div class="row mb-5">
						<div class="col-md-4 official">
							...
							<h4 class="h4">Program Head, Bachelor in Secondary Education</h4>
						</div>
						<div class="col-md-4 official">
							<div class="official-photo-2 mb-3">
							...
							<h4 class="h4">Program Head, Bachelor in Elementary Education</h4>
						</div>
						<div class="col-md-4 official">
							<div class="official-photo-2 mb-3">
								<img src="<?= get_stylesheet_directory_uri(); ?>/images/officials/aziel.estilo.jpg" alt="">
							</div>
							<h3 class="h3">Instr. Aziel Lyn Y. Estilo</h3>
							<h4 class="h4">Program Head, Bachelor in Technology and Livelihood Education</h4>
						</div>
					</div>
					<h3 class="h1 text-center mb-4">Faculty</h3>
					<div class="row mb-5">
				...
				<div class="college mb-5 pb-5">
					...
					<div class="row mb-5">
						<div class="col-md-4 official">
							...
							<h3 class="h3">Instr. French Mariee Edang</h3>
						</div>
						<div class="col-md-4 official">
							<div class="official-photo-3 mb-3">
							...
							<h4 class="h4">Chair, Filipino Department</h4>
						</div>
						<div class="col-md-4 official">
							<div class="official-photo-3 mb-3">
					...
					<div class="row mb-5">
						...
						<div class="col-md-4 official">
							...
							<h4 class="h4">Program Head, BPA</h4>
				...
				<div class="college mb-5 pb-5">
					...
					<div class="row mb-5">
						...
						<div class="col-md-4 official">
							...
							<h4 class="h4">Dean</h4>
							<h4 class="h4">Program Head, Electrical Engineering</h4>
						</div>
						<div class="col-md-4">
						</div>
					</div>
					...
					<div class="row mb-5">
						<div class="col-md-4 official">
							...
							<h4 class="h4">Program Head, BIT</h4>
						</div>
						<div class="col-md-4 official">
							<div class="official-photo-2 mb-3">
					...
					<div class="row mb-5">
						...
						<div class="col-md-4 official">
							<div class="official-photo-3 mb-3">
								<img src="<?= get_stylesheet_directory_uri(); ?>/images/officials/crisanto.occena.jpg" alt="">
							</div>
							<h3 class="h3">Dr.  Crisanto G. Occeña</h3>
						</div>
