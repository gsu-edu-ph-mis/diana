	...
	<div class="container">
		<main id="main" class="form-row pt-5 pb-5  text-left" role="main">
			...
			if ( $query->have_posts() ) : 
				...
				?>
				<h2 class="h2 mb-5">There <?php printf(_n( 'is %s article', 'are %s articles', $query->found_posts, 'diana' ), number_format_i18n( $query->found_posts )) ?> for SDG <?= $SDG; ?></h2>
