				...
				<div class="college mb-5 pb-5">
					...
					<div class="row mb-5">
						<div class="col-md-4 text-center mb-5">
							<div class="mb-3">
								<img src="<?= get_stylesheet_directory_uri(); ?>/images/logo.png" width="200" height="200" alt="OVP">
							</div>
							<h3 class="h3">Guimaras State College</h3>
							<h3 class="h4"><a href="tel:0335808244">
							...
							<h3 class="h4">
								<a href="mailto:guimstate@gsc.edu.ph">
								...
								<a href="https://www.facebook.com/GuimarasStateCollege">
						...
						<div class="col-md-4 text-center mb-5">
							<div class="mb-3">
								<img src="<?= get_stylesheet_directory_uri(); ?>/images/logos/icto.png" width="200" height="200" alt="ICTO">
							</div>
						...
						<div class="col-md-4 text-center mb-5">
							<div class="mb-3">
								<img src="<?= get_stylesheet_directory_uri(); ?>/images/logos/gradschool.png" width="200" height="200" alt="ICTO">
							</div>
